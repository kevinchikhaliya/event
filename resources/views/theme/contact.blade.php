        ...
        <div class="col-md-12 col-lg-7 mb-5">
          {{-- <div class="col-lg-4 ml-auto"> --}}
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4 text-black">205 Balaji hall, Rajkot, Gujarat, India</p>
              <p class="mb-0 font-weight-bold text-black">Phone</p>
              <p class="mb-4"><a href="#">+91 8238222848</a></p>
              <p class="mb-0 font-weight-bold text-black">Email Address</p>
              <p class="mb-0"><a href="#">kevinpatel828@gmail.com</a></p>
            </div>
    
        {{-- </div> --}}
          <div class="p-4 mb-3 bg-white">
            <h3 class="h5 text-black mb-3 text-black"></h3>
            <p class="text-black">Happy to assist you :)</p>
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="mb-5">
            <h3 class="footer-heading mb-4">About Even0.com</h3>
