...
<head>
    ...
    {{-- //KTMAZXVXFNBAN6GBODD2O7NZ6TN3MRRU --}}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                    <a href="single/{{$event->id}}"><img src="storage/event_posters/{{$event->EventPoster}}"
                            alt="Event Poster" class="img-fluid"></a>
                    <div class="p-4 bg-white">
                        <span class="d-block text-secondary small text-uppercase">Date: {{$event->Eventdate}} <br>
                            Time:{{$event->EventTime}}</span>
